...
const BackupReg: React.FC = () => {
  ...
  const inputClass = `w-full px-4 py-3 border-2 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent transition-colors ${
    isDarkMode
  ...
  return (
    <div className={`font-[lexend] w-full rounded-lg shadow-md transition-colors duration-300 ${
      ...
      <section className={`min-h-screen rounded-lg shadow-md p-2 lg:p-6 transition-colors duration-300 ${
        ...
        {/* Info Banner */}
        <div className={`mb-6 border-l-4 border-blue-500 p-4 rounded ${
          isDarkMode ? 'bg-blue-900/30' : 'bg-blue-50'
        }`}>
          <div className="flex items-start gap-3">
            <AlertCircle className="w-5 h-5 text-blue-500 shrink-0 mt-0.5" />
            <div>
              <h4 className={`text-sm font-semibold mb-1 ${isDarkMode ? 'text-blue-300' : 'text-blue-800'}`}>
                Backup Registration Info
              </h4>
              <p className={`text-xs ${isDarkMode ? 'text-blue-400' : 'text-blue-700'}`}>
                This form allows you to register walk-in users who didn't pre-register. All fields marked with{' '}
        ...
        <div className={`max-w-4xl mx-auto rounded-lg p-6 space-y-6 transition-colors duration-300 ${
          ...
          {/* Local Assembly */}
          <div>
            <label className={labelClass}>Local Assembly</label>
            <input
              type="text"
          ...
          <div>
            <label className={labelClass}>Local Assembly Address</label>
            <textarea
          ...
          <div className="flex gap-4 pt-6">
            ...
            <button
              onClick={handleReset}
              disabled={processing}
              className={`px-6 py-4 font-semibold rounded-lg flex items-center gap-2 transition-colors ${
                isDarkMode
